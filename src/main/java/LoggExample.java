 ...
 *
 */
public class LoggExample extends ConnectionAdapter{
     ...
     */
    public LoggExample(ConnectionData connectionData) {
...
//        }
        ...
        if (foundCrazyflies.size() > 0) {
            LoggExample loggingExample = new LoggExample(foundCrazyflies.get(0));
